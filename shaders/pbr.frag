...
void main() {
    ...
    float metallic      = per_object_data.objects[ f_instance ].m_metallic_roughness.x;
    float roughness     = per_object_data.objects[ f_instance ].m_metallic_roughness.y;
    out_material        = vec4( 1.0, metallic, roughness, f_instance ); 
}