...
namespace MiniEngine
{
    ...
    class ShadowPassVK_RTX final : public RenderPassVK
    {
    public:
        ShadowPassVK_RTX(
    ...
    private:
        ShadowPassVK_RTX(const ShadowPassVK_RTX&) = delete;
        ShadowPassVK_RTX& operator=(const ShadowPassVK_RTX&) = delete;
