...
namespace MiniEngine
{
    ...
    class LightingPassVK final : public RenderPassVK
    {
    public:
        LightingPassVK( 
    ...
    private:
        LightingPassVK( const LightingPassVK& ) = delete;
        LightingPassVK& operator=(const LightingPassVK& ) = delete;
