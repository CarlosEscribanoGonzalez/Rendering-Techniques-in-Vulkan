...
namespace MiniEngine
{
    ...
    public:
        ...
        static Matrix4f getLightSpaceMatrix_Dir(std::shared_ptr<Light> i_light, Camera& i_camera);
        static std::array<Matrix4f, 6> getLightSpaceMatrix_Point(std::shared_ptr<Light> i_light, Camera& i_camera);
