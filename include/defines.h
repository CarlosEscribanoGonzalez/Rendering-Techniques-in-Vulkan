...
namespace MiniEngine
{
    ...
    constexpr uint32_t kSSAO_NOISE_SIZE = 16;
    constexpr uint32_t kSHADOWS_RES = 2048;
    constexpr uint32_t kMAX_CASCADES = 4;
    constexpr uint32_t kLAYERS_PER_LIGHT = 6;
    constexpr float kLAMBDA = 0.5f; //Cascading division, must be in range [0, 1]
};