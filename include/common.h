...
namespace MiniEngine
{
    ...
    struct Attachments
    {
        ...
        ImageBlock m_motionVectors_attachment;
        //ADDITIONAL RENDER TARGET
        ImageBlock m_ssao_attachment;
        ImageBlock m_ssao_blur_attachment;
        ImageBlock m_lighting_attachment;
        ImageBlock m_taa_history_attachment;
        std::array<ImageBlock, 2> m_pp_attachments;
        //SHADOWS
        ImageBlock m_shadow_attachment;
        ImageBlock m_visibility_attachment;
        ImageBlock m_denoise_history_attachment;
    };
};