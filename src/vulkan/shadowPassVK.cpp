...
VkCommandBuffer ShadowPassVK::draw( const Frame& i_frame)
{
    ...
    render_pass_info.renderArea.extent = { kSHADOWS_RES, kSHADOWS_RES };
...
void ShadowPassVK::createFbo()
{
    ...
    for( size_t i = 0; i < m_fbos.size(); i++ )
    {
        ...
        attachments[ 0 ] = m_shadow_buffer.m_image_view;         // shadow buffer
        ...
        framebuffer_create_info.width           = kSHADOWS_RES;
        framebuffer_create_info.height          = kSHADOWS_RES;
        framebuffer_create_info.layers          = kMAX_NUMBER_LIGHTS * kLAYERS_PER_LIGHT;
...
void ShadowPassVK::createRenderPass()
{
    ...
    subpass_description.pDepthStencilAttachment = &shadow_reference;
...
void ShadowPassVK::createPipelines()
{
    ...
    VkExtent2D extend{ kSHADOWS_RES, kSHADOWS_RES };

    VkViewport viewport{};
    viewport.x          = 0.0f;
    viewport.y          = 0.0f;
    viewport.width      = (float) kSHADOWS_RES;
    viewport.height     = (float) kSHADOWS_RES;
