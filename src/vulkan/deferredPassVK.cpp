...
bool DeferredPassVK::initialize()
{
    ...
    //SHADER STAGES
    {
        ...
        VkShaderModule pbr_module         = m_runtime.m_shader_registry->loadShader( "./shaders/pbr.spv"        , VK_SHADER_STAGE_FRAGMENT_BIT );
...
void DeferredPassVK::createRenderPass()
{
    ...
    VkSampleCountFlagBits samples = UtilsVK::getSampleCountFlag_AA();
    // Color attachment
...
void DeferredPassVK::createPipelines()
{
    ...
    multisampling.rasterizationSamples  = UtilsVK::getSampleCountFlag_AA();
